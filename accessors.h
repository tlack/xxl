...
static inline VP xb(int8_t x) { VP a; a=xalloc(2,1); EL(a,int8_t,0)=x; a->n=1; return a; }
static inline VP xb0() { VP a=xalloc(2,1); return a; }
static inline VP xbsz(sz) { VP a=xalloc(2,sz); return a; }
static inline VP xba(VP a, int8_t x) { a=xrealloc(a,a->n++);EL(a,int8_t,a->n-1)=x; return a; }
static inline VP xbn(int nargs,...) { VP a; va_list args; int i; int x; a=xalloc(2,nargs); a->n=nargs; va_start(args,nargs);\
...
#define AS_i(v,n) ({ \
	...
	int __x=EL(v,int,n); __x; })
static inline VP xi(int x) { VP a; a=xalloc(3,1); EL(a,int,0)=x; a->n=1; return a; }
static inline VP xi0() { VP a=xalloc(3,1); return a; }
static inline VP xisz(sz) { VP a=xalloc(3,sz); return a; }
static inline VP xia(VP a, int x) { a=xrealloc(a,a->n++);EL(a,int,a->n-1)=x; return a; }
static inline VP xin(int nargs,...) { VP a; va_list args; int i; int x; a=xalloc(3,nargs); a->n=nargs; va_start(args,nargs);\
	for(i=0;i<nargs;i++){ x=va_arg(args,int); EL(a,int,i)=x; }\
	return a; }
...
static inline VP xj(__int64_t x) { VP a; a=xalloc(4,1); EL(a,__int64_t,0)=x; a->n=1; return a; }
static inline VP xj0() { VP a=xalloc(4,1); return a; }
static inline VP xjsz(sz) { VP a=xalloc(4,sz); return a; }
static inline VP xja(VP a, __int64_t x) { a=xrealloc(a,a->n++);EL(a,__int64_t,a->n-1)=x; return a; }
static inline VP xjn(int nargs,...) { VP a; va_list args; int i; int x; a=xalloc(4,nargs); a->n=nargs; va_start(args,nargs);\
...
static inline VP xo(__int128_t x) { VP a; a=xalloc(5,1); EL(a,__int128_t,0)=x; a->n=1; return a; }
static inline VP xo0() { VP a=xalloc(5,1); return a; }
static inline VP xosz(sz) { VP a=xalloc(5,sz); return a; }
static inline VP xoa(VP a, __int128_t x) { a=xrealloc(a,a->n++);EL(a,__int128_t,a->n-1)=x; return a; }
static inline VP xon(int nargs,...) { VP a; va_list args; int i; int x; a=xalloc(5,nargs); a->n=nargs; va_start(args,nargs);\
...
static inline VP xc(char x) { VP a; a=xalloc(6,1); EL(a,char,0)=x; a->n=1; return a; }
static inline VP xc0() { VP a=xalloc(6,1); return a; }
static inline VP xcsz(sz) { VP a=xalloc(6,sz); return a; }
static inline VP xca(VP a, char x) { a=xrealloc(a,a->n++);EL(a,char,a->n-1)=x; return a; }
static inline VP xcn(int nargs,...) { VP a; va_list args; int i; int x; a=xalloc(6,nargs); a->n=nargs; va_start(args,nargs);\
...
#define AS_d(v,n) ({ \
	...
	VP __x=EL(v,VP,n); __x; })
static inline VP xd(VP x) { VP a; a=xalloc(7,1); EL(a,VP,0)=x; a->n=1; return a; }
static inline VP xd0() { VP a=xalloc(7,1); return a; }
static inline VP xdsz(sz) { VP a=xalloc(7,sz); return a; }
static inline VP xda(VP a, VP x) { a=xrealloc(a,a->n++);EL(a,VP,a->n-1)=x; return a; }
static inline VP xdn(int nargs,...) { VP a; va_list args; int i; VP x; a=xalloc(7,nargs); a->n=nargs; va_start(args,nargs);\
	for(i=0;i<nargs;i++){ x=va_arg(args,VP); EL(a,VP,i)=x; }\
	return a; }
...
static inline VP x1(unaryFunc* x) { VP a; a=xalloc(8,1); EL(a,unaryFunc*,0)=x; a->n=1; return a; }
static inline VP x10() { VP a=xalloc(8,1); return a; }
static inline VP x1sz(sz) { VP a=xalloc(8,sz); return a; }
static inline VP x1a(VP a, unaryFunc* x) { a=xrealloc(a,a->n++);EL(a,unaryFunc*,a->n-1)=x; return a; }
static inline VP x1n(int nargs,...) { VP a; va_list args; int i; unaryFunc* x; a=xalloc(8,nargs); a->n=nargs; va_start(args,nargs);\
...
static inline VP x2(binaryFunc* x) { VP a; a=xalloc(9,1); EL(a,binaryFunc*,0)=x; a->n=1; return a; }
static inline VP x20() { VP a=xalloc(9,1); return a; }
static inline VP x2sz(sz) { VP a=xalloc(9,sz); return a; }
static inline VP x2a(VP a, binaryFunc* x) { a=xrealloc(a,a->n++);EL(a,binaryFunc*,a->n-1)=x; return a; }
static inline VP x2n(int nargs,...) { VP a; va_list args; int i; binaryFunc* x; a=xalloc(9,nargs); a->n=nargs; va_start(args,nargs);\
...
static inline VP xp(Proj x) { VP a; a=xalloc(10,1); EL(a,Proj,0)=x; a->n=1; return a; }
static inline VP xp0() { VP a=xalloc(10,1); return a; }
static inline VP xpsz(sz) { VP a=xalloc(10,sz); return a; }
static inline VP xpa(VP a, Proj x) { a=xrealloc(a,a->n++);EL(a,Proj,a->n-1)=x; return a; }
static inline VP xpn(int nargs,...) { VP a; va_list args; int i; Proj x; a=xalloc(10,nargs); a->n=nargs; va_start(args,nargs);\
...
#define AS_x(v,n) ({ \
	...
	VP __x=EL(v,VP,n); __x; })
static inline VP xx(VP x) { VP a; a=xalloc(11,1); EL(a,VP,0)=x; a->n=1; return a; }
static inline VP xx0() { VP a=xalloc(11,1); return a; }
static inline VP xxsz(sz) { VP a=xalloc(11,sz); return a; }
static inline VP xxa(VP a, VP x) { a=xrealloc(a,a->n++);EL(a,VP,a->n-1)=x; return a; }
static inline VP xxn(int nargs,...) { VP a; va_list args; int i; VP x; a=xalloc(11,nargs); a->n=nargs; va_start(args,nargs);\
	for(i=0;i<nargs;i++){ x=va_arg(args,VP); EL(a,VP,i)=x; }\
	return a; }
