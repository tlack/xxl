...
char* repr_b(VP x,char* s,size_t sz) { int i, xn=x->n; 
...
char* repr_i(VP x,char* s,size_t sz) { int i, xn=x->n; 
...
char* repr_j(VP x,char* s,size_t sz) { int i, xn=x->n; 
...
char* repr_f(VP x,char* s,size_t sz) { int i, xn=x->n; 
...
char* repr_1(VP x,char* s,size_t sz) { int i, xn=x->n; 
...
char* repr_2(VP x,char* s,size_t sz) { int i, xn=x->n; 
