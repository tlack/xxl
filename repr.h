...
else snprintf(s+strlen(s),sz-strlen(s)-1,"%d",AS_b(x,i)); 
...
else snprintf(s+strlen(s),sz-strlen(s)-1,"%d",AS_i(x,i)); 
if(!SIMPLE(x) || x->n>1) APF(sz,")",0);
return s; }
...
else snprintf(s+strlen(s),sz-strlen(s)-1,"%ld",AS_j(x,i)); 
if(!SIMPLE(x) || x->n>1) APF(sz,")",0);
return s; }
...
else snprintf(s+strlen(s),sz-strlen(s)-1,"%llld",AS_o(x,i)); 
if(!SIMPLE(x) || x->n>1) APF(sz,")",0);
return s; }
...
else snprintf(s+strlen(s),sz-strlen(s)-1,"%p",AS_1(x,i)); 
if(!SIMPLE(x) || x->n>1) APF(sz,")",0);
return s; }
...
else snprintf(s+strlen(s),sz-strlen(s)-1,"%p",AS_2(x,i)); 
if(!SIMPLE(x) || x->n>1) APF(sz,")",0);
return s; }
