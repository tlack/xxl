...
#define VARY_EL(x,i,stmt,failvar) ({ \
	...
	if(x->t==9){/*cant vary table*/ failvar=9;}\
	if(x->t==10){/*cant vary f1*/ failvar=10;}\
	if(x->t==11){/*cant vary f2*/ failvar=11;}\
	if(x->t==12){/*cant vary proj*/ failvar=12;}\
...
#define VARY_EACH(x,stmt,failvar) ({ \
	...
	if(_xt==11){/*cant vary f2*/ failvar=11; }\
	if(_xt==12){/*cant vary proj*/ failvar=12; }\
	if(_xt==13){/*cant vary ctx*/ failvar=13; }\
	if(_xt==1){/*tag*/ \
		tag_t _x,_xtmp=0;\
...
#define VARY_EACHBOTH(x,y,stmt,failvar) ({ \
	...
	if(_xt==9||_yt==9){/*cant vary table*/ failvar=9; }\
	if(_xt==10||_yt==10){/*cant vary f1*/ failvar=10; }\
	if(_xt==11||_yt==11){/*cant vary f2*/ failvar=11; }\
	if(_xt==12||_yt==12){/*cant vary proj*/ failvar=12; }\
	if(_xt==13||_yt==13){/*cant vary ctx*/ failvar=13; }\
